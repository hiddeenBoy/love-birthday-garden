    ...
    <div className="max-w-4xl mx-auto my-16 px-4 text-center">
      <div className="mb-8">
        <h2 className="font-display text-3xl font-bold text-love-800 mb-2 flex items-center justify-center">
          <Gift className="mr-2 text-love-600" size={24} />
          A Special Gift For You
        </h2>
        <p className="text-love-600 text-lg max-w-md mx-auto">
          Click to unwrap your virtual present!
        </p>
      </div>
      ...
      >
        <div className="relative w-64 h-64 mx-auto">
          ...
          <div className="absolute -top-5 -right-5">
            <Heart size={40} className="text-love-600" fill="#F43F75" />
          </div>
        </div>
      </button>

      <Dialog open={showDialog} onOpenChange={setShowDialog}>
        <DialogContent className="sm:max-w-md glass-morphism border-love-200">
          <DialogHeader>
            <DialogTitle className="text-center text-2xl font-display text-love-800">
              Your Special Gift
            </DialogTitle>
            ...
            >
              <div className="text-center">
                ...
                <div className="animate-float">
                  <Heart size={80} className="text-love-600 mx-auto" fill="#F43F75" />
                </div>
              </div>
            </div>
